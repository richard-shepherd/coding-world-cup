...
namespace BootAndShoot
{
    ...
    public abstract class CodingWorldCupAPI
    {
        ...
        /// </summary>
        protected virtual void processEvent_StartOfTurn(dynamic data)
        {
        ...
        /// </summary>
        protected void storeTeamInfo(dynamic teamInfo)
        {
        ...
        /// </summary>
        protected void storeOpposingTeamInfo(dynamic teamInfo)
        {
        ...
        protected Position oldPosition = new Position(0.0, 0.0);
        ...
        protected Ball ball = Ball.instance;
